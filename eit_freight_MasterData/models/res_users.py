...
class InheritResUsers(models.Model):
    ...
    def get_is_hide_archive_and_applied_models(self):
        ...
        # the following models will be excluded from archive removing
        exclude_archive_user = ['res.partner', 'sea.river', 'ocean.data', 'carrier.route', 'package.type']
        exclude_archive_manager = exclude_archive_user + []
        exclude_archive_form = ['res.partner']
        exclude_archive_list = []
        return {
            "exclude_archive_form": exclude_archive_form,
            "exclude_archive_list": exclude_archive_list,
            "exclude_archive_user": exclude_archive_user,
            "exclude_archive_manager": exclude_archive_manager,
